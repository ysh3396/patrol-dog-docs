...
| U24 | 반려견 등록/수정 | 반려견 | 사진·이름·견종·성별·생년월일·중성화·예방접종·성격 등록/수정 폼 | [app/08-dog-registration.md](app/08-dog-registration.md#u24-반려견-등록수정) |
| U24a | 견종 선택 | 반려견 | 검색 + 목록에서 견종 선택 또는 직접 입력 | [app/08-dog-registration.md](app/08-dog-registration.md#u24a-견종-선택) |
| U25 | 산책 일지 | 순찰 | 월별 캘린더 + 반려견 통계 카드(총 횟수/거리/시간/상위 %) | [app/09-patrol-diary.md](app/09-patrol-diary.md#u25-산책-일지) |
...
| 구분 | 화면 수 | 비고 |
|------|---------|------|
| 모바일 앱 (U00~U25) | 30개 | U00 계열 5개(U00/a/b/c/d) + U02~U25 25개. U01 미정의. |
| 관리자 웹 (A01~A10) | 10개 | A10 와이어프레임 미작성 |
| **합계** | **40개** | |

> **비고**: U24는 등록/수정 겸용 화면. U02-empty는 U02의 조건부 빈 상태로 별도 화면 카운트에 미포함.
